...
import UserTable from "../../Components/UserSelectTable/UserTable";
...
const SelectUsers = ({ props }) => {
  ...
  return (
    <div style={{ marginTop: 64 }}>
      <UserTable
        usersList={usersList}
        getTellusAns={getTellusAns}
        getHearingAns={getHearingAns}
      />
      {TellusClicked == 1 && nav("/tellus/" + user)}
      {HearingClicked == 1 && nav("/hearingdiary/" + user)}
    </div>
